...
const _catalog = <_CertType>[
  ...
  _CertType(
    ...
    levels: [
      ...
      _CertLevel(
        id: 'iso22_export',
        nameEn: 'Premium — Third-party audit prep',
        nameFr: 'Premium — Préparation audit tiers',
  ...
  _CertType(
    ...
    descEn: 'Ethical sourcing & cooperative premium pathways',
    ...
    levels: [
      ...
      _CertLevel(
        ...
        summaryEn: 'Processor + cooperative linkage with premium traceability.',
