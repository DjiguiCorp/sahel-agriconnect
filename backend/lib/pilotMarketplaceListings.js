/**
 * Pilot rows for CommodityMarketplace — matches ProduceListing schema
 * (visibility marketplace, promoted, cooperativeApproved, status active).
 */
export function buildPilotListings(now) {
  return [
    {
