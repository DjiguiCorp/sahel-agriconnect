...
export const validateFarmer = (req, res, next) => {
  const schema = Joi.object({
    ...
    autresCultures: Joi.string().allow('').optional(),
    autresElevage: Joi.string().allow('').optional(),
    culturesDisplay: Joi.array().items(Joi.string()).optional(),
...
export const validateProcessor = (req, res, next) => {
  const schema = Joi.object({
    ...
    autresTypesProduits: Joi.string().allow('').optional(),
    autresProduitsAcceptes: Joi.string().allow('').optional(),
