...
export const PORTAL_META = {
  farmer: {
    ...
    signInPath: '/connexion?role=farmer',
  ...
  cooperative: {
    ...
    signInPath: '/connexion?role=cooperative',
  ...
  investor: {
    ...
    signInPath: '/connexion?role=investor',
  ...
  processor: {
    brand: 'sahel',
    icon: '🏭',
    portalPath: '/transformation-registration',
    registerPath: '/transformation-registration',
    signInPath: '/connexion?role=processor',
  ...
  government: {
    ...
    signInPath: '/connexion?role=government',
