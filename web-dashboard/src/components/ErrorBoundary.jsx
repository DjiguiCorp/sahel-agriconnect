    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-xl font-bold text-[#1a3c2e] mb-2">Something went wrong</h2>
          ...
          <button
            ...
            className="flex items-center gap-2 mx-auto px-6 py-2.5 bg-[#1a3c2e] text-white rounded-xl font-semibold text-sm hover:bg-[#143326] transition"
          >
